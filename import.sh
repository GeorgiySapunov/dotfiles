...
rsync -uvrP --delete-after ~/.config/zsh/.zshrc         ~/git/dotfiles/.config/
rsync -uvrP --delete-after ~/.config/zsh/aliases.zsh    ~/git/dotfiles/.config/
rsync -uvrP --delete-after ~/.config/zsh/exports.zsh    ~/git/dotfiles/.config/
