...
rsync -uvrP --delete-after ~/.config/kitty                        ~/git/dotfiles/.config
...
rsync -uvrP --delete-after ~/.config/lf/lfrc                      ~/git/dotfiles/.config/lf/
rsync -uvrP --delete-after ~/.config/lf/icons                     ~/git/dotfiles/.config/lf/
rsync -uvrP --delete-after ~/.config/lf/lf_kitty_clean            ~/git/dotfiles/.config/lf/
rsync -uvrP --delete-after ~/.config/lf/lf_kitty_preview          ~/git/dotfiles/.config/lf/
...
rsync -uvrP --delete-after ~/.config/zsh/aliases.zsh              ~/git/dotfiles/.config/zsh/
rsync -uvrP --delete-after ~/.config/zsh/exports.zsh              ~/git/dotfiles/.config/zsh/
